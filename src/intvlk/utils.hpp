...
namespace intvlk
{
		...
		const vk::Extent2D& destinationExtent)
	{
		...
		vk::ImageBlit2 blitRegion{
			...
			std::array<vk::Offset3D, 2>{vk::Offset3D{0, 0, 0}, vk::Offset3D{static_cast<int32_t>(sourceExtent.width),
	...
	inline vk::raii::DescriptorSetLayout makeDescriptorSetLayout(const vk::raii::Device& device,
	...
	inline vk::raii::Pipeline makeGraphicsPipeline(const vk::raii::Device& device,
